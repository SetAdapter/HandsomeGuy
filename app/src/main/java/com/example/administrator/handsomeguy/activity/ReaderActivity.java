 ...
 */
public class ReaderActivity extends BaseActivity implements IBookChapters {
    ...
    private ContentObserver mBrightObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (BRIGHTNESS_MODE_URI.equals(uri)) {
                Log.d(TAG, "亮度模式改变");
            } else if (BRIGHTNESS_URI.equals(uri) && !BrightnessUtils.isAutoBrightness(ReaderActivity.this)) {
            ...
            } else if (BRIGHTNESS_ADJ_URI.equals(uri) && BrightnessUtils.isAutoBrightness(ReaderActivity.this)) {
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        mCollBook = (CollBookBean) bundle.getSerializable(EXTRA_COLL_BOOK);
    ...
    @OnClick({R.id.tv_toolbar_title, R.id.read_tv_pre_chapter, R.id.read_tv_next_chapter, R.id.read_tv_category,
            R.id.read_tv_night_mode, R.id.read_tv_setting})
