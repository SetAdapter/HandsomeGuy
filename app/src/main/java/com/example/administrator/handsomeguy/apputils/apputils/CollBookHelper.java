...
import com.example.administrator.handsomeguy.apputils.helper.BookDownloadHelper;
import com.example.administrator.handsomeguy.apputils.helper.DaoDbHelper;
import com.example.handsomelibrary.api.ApiService;
import com.example.handsomelibrary.model.gen.CollBookBean;
import com.example.handsomelibrary.model.gen.CollBookBeanDao;
    ...
    public Observable<String> removeBookInRx(CollBookBean collBookBean) {
        return Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> e) throws Exception {
                //查看文本中是否存在删除的数据
                FileUtils.deleteFile(ApiService.BOOK_CACHE_PATH + collBookBean.get_id());
                //删除任务
