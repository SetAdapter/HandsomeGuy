...
import com.example.administrator.handsomeguy.adapter.ReadBgAdapter;
import com.example.administrator.handsomeguy.adapter.ReadBgBean;
    ...
    private void initClick() {
        ...
        mReadBgAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                ReadSettingDialog.this.setReadBg(position);
