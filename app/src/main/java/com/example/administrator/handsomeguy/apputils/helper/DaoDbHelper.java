...
import com.example.handsomelibrary.model.gen.DaoMaster;
...
public class DaoDbHelper {
    ...
    private DaoDbHelper() {
        //封装数据库的创建、更新、删除
        DaoMaster.DevOpenHelper openHelper = new DaoMaster.DevOpenHelper(BaseApp.getAppContext(), DB_NAME, null);
        //获取数据库
