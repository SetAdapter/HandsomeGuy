...
public class BoysBookListAdapter extends BaseQuickAdapter<ClassifyBean.DataBean.MaleBean,BaseViewHolder>{

    public BoysBookListAdapter(@Nullable List<ClassifyBean.DataBean.MaleBean> data) {
        super(R.layout.book_list_item, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ClassifyBean.DataBean.MaleBean item) {
